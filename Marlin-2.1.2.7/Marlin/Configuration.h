 ...
 */
// because we are using lead screws for all axes of the cnc machine,
// the steps per unit for xyz should all be the same. default = { 80, 80, 400, 500 }
// E0 doesn't matter; it just for the extruder
...
#define HOMING_FEEDRATE_MM_M { (50*20), (50*20), (4*60) }
